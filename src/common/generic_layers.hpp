...
public:
  ...
  static constexpr OsiLayer LAYER_IDX{OsiLayer::DATA_LINK_IDX};
...
// For now, I'm assuming all L1, L2, L3 and L4 entities are addressable, although
// there may be exceptions in practice. When I encounter them, nmaybe I'll apply
// these assertions to specific entities instead (e.g. IP, TCP, UDP, etc.)

static_assert(IsAddressableEntity<GenericL2Entity>,
              "GenericL2Entity does not satisfy IsAddressableLayerType concept "
              "requirements !");
static_assert(IsAddressableEntity<GenericL3Entity>,
              "GenericL3Entity does not satisfy IsAddressableLayerType concept "
              "requirements !");
static_assert(IsAddressableEntity<GenericL4Entity>,
              "GenericL4Entity does not satisfy IsAddressableLayerType concept "
              "requirements !");
